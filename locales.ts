...
export const translations: Record<Language, any> = {
  uz: {
    ...
    cart: { title: 'Savatcha', empty: 'Savatchangiz bo\'sh', checkout: 'Buyurtma berish', add: 'Savatga qo\'shish', added: 'Savatchaga qo\'shildi!', total: 'Jami' },
  ...
  ru: {
    ...
    cart: { title: 'Корзина', empty: 'Корзина пуста', checkout: 'Оформить заказ', add: 'В корзину', added: 'Добавлено в корзину!', total: 'Итого' },
  ...
  en: {
    ...
    cart: { title: 'Shopping Cart', empty: 'Cart is empty', checkout: 'Checkout', add: 'Add to Cart', added: 'Added to cart!', total: 'Total' },
  ...
  tr: {
    ...
    cart: { title: 'Sepetim', empty: 'Sepet boş', checkout: 'Sipariş Ver', add: 'Sepete Ekle', added: 'Sepete eklendi!', total: 'Toplam' },
