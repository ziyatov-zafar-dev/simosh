...
export const translations: Record<Language, any> = {
  uz: {
    ...
    cart: { 
      ...
      promoErrorExpired: 'Promo-kod muddati o\'tgan yoki faol emas!',
      promoErrorMinAmount: 'Minimal buyurtma miqdori: {amount} so\'m bo\'lishi kerak!',
      subtotal: 'Summa',
  ...
  ru: {
    ...
    cart: { 
      ...
      promoErrorNotFound: 'Промокод не найден!',
      promoErrorExpired: 'Промокод истек или неактивен!',
      promoErrorMinAmount: 'Минимальная сумма заказа: {amount} сум!',
      subtotal: 'Сумма',
  ...
  en: {
    ...
    cart: { 
      ...
      promoErrorExpired: 'Promo code expired or inactive!',
      promoErrorMinAmount: 'Minimum order amount: {amount} UZS!',
      subtotal: 'Subtotal',
  ...
  tr: {
    ...
    cart: { 
      ...
      promoErrorNotFound: 'Promosyon kodu bulunamadı!',
      promoErrorExpired: 'Promosyon kodunun süresi dolmuş veya geçersiz!',
      promoErrorMinAmount: 'Minimum sipariş tutarı: {amount} UZS!',
      subtotal: 'Ara Toplam',
